  ...
  return (
    <div className="pt-40 md:pt-20" id="experiencia">
      ...
      <p className="m-auto text-center text-black dark:text-white w-[70%] mb-7 font-extralight md:text-xl text-lg">
        Un recorrido por mi trayectoria, destacando los proyectos más relevantes en los que he trabajado y las
        habilidades que he desarrollado a lo largo del camino.
      </p>
      <div className="py-10 w-full rounded-3xl font-sans md:px-10" ref={containerRef}>
        <div className="text-center max-w-7xl mx-auto px-4 md:px-8 lg:px-10"></div>
